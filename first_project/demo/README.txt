...
To run this project, you need the following:
    ...
    Java Development Kit (JDK)
        ...
        Download and install from: https://adoptium.net/ or Oracle.
...
(Optional) If the project requires an external database, configure the database connection in the src/main/resources/application.properties file:
